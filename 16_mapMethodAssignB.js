class Employee{
   ...
   const newArray= array_employees.map((currentValue)=>{
    ...
    const listOfDepartment= array_employees.map((currentValue)=>{
       return currentValue.emp_dept;
    })
    console.log(listOfDepartment);
    console.log(`3.Get the list of employee ids and log on console`);
    const empId= array_employees.map((currentValue)=>{
        return currentValue.emp_id
    })
    console.log(empId);
    console.log(`4.Get the list of Employee names Working in TCS`);

        array_employees.map((currentValue)=>{
